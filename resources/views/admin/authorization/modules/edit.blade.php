            ...
            <div class="d-flex align-items-center justify-content-end">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Chỉnh sửa Module</li>
                    </ol>
                </nav>
            </div>
        </div>
...
<div class="container-fluid">
    <div class="card" style="border: none; border-radius: 0px;">
        <div class="card-body">
            ...
            @endif
            <form class="form-horizontal form-material row" action="{{route('modules.update', $module->id)}}" method="POST">
                @csrf
                @method('put')
                <div class="form-group">
                    <label class="col-md-12">Tên nhà xuất bản <span class="text-danger">(*)</span></label>
                    <div class="col-md-12">
                        <input type="text" name="name" value="{{ $module->name  }}" class="form-control form-control-line">
                    </div>
                </div>
                <div class="form-group col-md-12 mt-3">
                    <label class="col-md-12">Tên gọi khác <span class="text-danger">(*)</span></label>
                    <div class="col-md-12">
                        <input type="text" name="slug" value="{{ $module->slug}}" class="form-control form-control-line">
                    </div>
                </div>
