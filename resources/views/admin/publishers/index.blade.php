...
<div class="container-fluid">
    ...
    <div class="form-group row justify-content-between align-content-center m-0 p-0">
        ...
        <div class="col-sm-6 my-auto">
            <form action="{{route('publishers.delete-list')}}" class="d-inline float-end" method="post" id="form-delete">
                @csrf
                <input type="text" value="" name="delete_list" id="songs-delete" class="delete_list" hidden>
                <button type="submit" class="btn btn-danger" onclick="return confirm('Xác nhận xóa nhà xuất bản đã chọn?')">Xóa nhà xuất bản</button>
            </form>
        </div>
